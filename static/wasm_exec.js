...
// Note: this was added here because Gatsby's develop process was executing the scripts out of order, which caused a reference error
...
WebAssembly.instantiateStreaming(fetch('../../hookscript.wasm'), go.importObject).then(result => {
	globalThis.compilerIsReady = true;
